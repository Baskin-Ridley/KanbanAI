            ...
            >
              ...
              <div>
                <Link
                  ...
                  className="bg-blue-500 text-white border border-transparent hover:bg-white hover:text-blue-500 rounded py-2 px-4 font-bold focus:outline-none transition-colors duration-200"
                  >
                  Edit
                </Link>
              </div>
