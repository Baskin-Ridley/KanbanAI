...
export const GitCard = () => {
          ...
          {Object.keys(data).map((e, i) => (
            <div className='gitCard'>
              ...
              <li>
                {' '}
                {data[e].parents ? (
                  <a href={data[e].parents[0].html_url}>
                    {' '}
  ...
  return (
    <div className='parent-container'>
      ...
      <button className='access-btn' id='commit-btn' onClick={() => clickHandler(states)}>
        Click me to get the commitCards
      </button>
